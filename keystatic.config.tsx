...
export default config({
    ...
    storage:
        import.meta.env.DEV === true ? { kind: "local" } : { kind: "cloud" },
    // cloud deployment is free to sign up (up to 3 users per team)
    // docs: https://keystatic.com/docs/cloud
    // create a Keystatic Cloud account here: https://keystatic.cloud/
            ...
            schema: {
                title: fields.slug({
                    ...
                    slug: {
                        ...
                        description:
                            "Never change the slug once a file is published!",
                    },
                }),
                ...
                authors: fields.array(
                    ...
                    }),
                    {
                        ...
                        itemLabel: (props) =>
                            props.value || "Please select an author",
                    },
                ),
            ...
            schema: {
                name: fields.slug({
                    ...
                    slug: {
                        label: "SEO-friendly slug",
                        description:
                            "Never change the slug once this file is published!",
                    },
                }),
                avatar: fields.image({
                    label: "Author avatar",
                ...
                email: fields.text({
                    ...
                    description:
                        "This must look something like `you@email.com`",
                    validation: { isRequired: true },
                }),
