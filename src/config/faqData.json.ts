...
export const faqData: FaqItem[] = [
  {
    question: "Why should I purchase this?",
    answer: `This theme is designed with your needs in mind - to make your life easy when creating website for clients. It offers speed, 
    customizability with swappable components, built-in SEO, and image optimization. Instead of spending 
    hours figuring out how to do this yourself, you can leverage our theme to save time and effort. You 
    can easily mix and match sections, update the copy, and change the color theme with just one line 
    of code. It's a perfect starting point for your next project or a great resource to learn how to 
    build a website with Astro. Plus, it's cost-effective. A few bucks spent today can save you countless 
    hours in the future, allowing you to focus on what you do best - creating amazing web experiences for your users.`,
  },
  {
