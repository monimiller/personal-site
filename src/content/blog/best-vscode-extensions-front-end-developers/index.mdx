...
pubDate: "2023-08-05"
heroImage: >-
    ../best-vscode-extensions-front-end-developers/orange-blobs-5.jpg
categories:
    - productivity
---
...
<Admonition variant="tip">
    Astro is my meta framework of choice for SSG and SSR, which allows you to
    use whatever UI framework you want within it (React, Vue, Solid, etc). I
    highly recommend it.
</Admonition>
