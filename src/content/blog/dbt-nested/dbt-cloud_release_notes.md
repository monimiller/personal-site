...
It's easy to brag about a feature that you personally utilize every day when discussing release notes. Hence, this is the reason I highlighted the DAG in the IDE. While the original DAG functionality was added in [**dbt Cloud v1.1.33** (August 18, 2021)](https://docs.getdbt.com/docs/dbt-versions/release-notes/dbt-cloud-changelog-2021#dbt-cloud-v1133-august-18-2021), here are the cliff notes of some additional changes that add to it's extraordinary power.

### Interesting Changelog Tidbits

- [dbt Cloud v1.1.33 (August 18, 2021)](https://docs.getdbt.com/docs/dbt-versions/release-notes/dbt-cloud-changelog-2021#dbt-cloud-v1133-august-18-2021) - _This release brings the developed DAG to the dbt Cloud IDE_.
- [dbt Cloud v1.1.37 (October 13, 2021)](https://docs.getdbt.com/docs/dbt-versions/release-notes/dbt-cloud-changelog-2021#dbt-cloud-v1137-october-13-2021) - _The command, `dbt build`, runs your complete workflow in DAG order. Basically, the DAG gives the relational visualization for everything in your kingdom that will execute while running `dbt build`._
- [dbt Cloud v1.1.44 (February 2nd, 2022)](https://docs.getdbt.com/docs/dbt-versions/release-notes/February-2022/DAG-updates-more) - _Add the double click enhancement to the DAG so that the model selected will automatically open in the IDE for your code viewing pleasure and quick navigation._
...
- [Introductory DAG article](https://analyticsengineers.club/whats-a-dag/) with some more good information by [Claire Carroll](https://clrcrl.com/)
- [Information on checking and upgrading your dbt version](https://docs.getdbt.com/docs/dbt-cloud/cloud-configuring-dbt-cloud/cloud-upgrading-dbt-versions#:~:text=You%20can%20see%20which%20dbt,,%20dbt-utils%20version%200.7.)

## Spotlight of the Week!

As we know, _Empowered Women Empower Women_. I plan to live out this mantra by amplifying one of my favorite things: women making their mark in tech. My goal each week is to highlight women I look up to, organizations I support, and general knowledge that I find interesting that pertains to this topic. This week, check out my blog post about [Elpha](/blog/sotw/elpha).
